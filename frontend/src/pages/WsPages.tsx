  ...
  <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }} className="content-wrap page-overlay">
    <section className="section">
      ...
      <div style={{ marginTop: '2rem' }}>
        ...
        <div style={{ marginTop: '2rem', padding: '1rem', background: 'rgba(245, 158, 11, 0.08)', borderRadius: '8px', border: '1px solid rgba(245, 158, 11, 0.2)' }}>
          <h3 style={{ fontSize: '1.25rem', marginBottom: '1rem', color: 'var(--accent-color, #f59e0b)' }}>Who is Involved?</h3>
          <p className="b2" style={{ maxWidth: '800px' }}>This section explores the people behind the project. Who is involved? Who are the key contributors? Who benefits from this work?</p>
          <p style={{ marginTop: '1rem', opacity: 0.8 }}>Superteam UK brings together developers, designers, and blockchain enthusiasts from universities across the UK. Our chapters are led by passionate organizers who are committed to growing the Rust and Web3 ecosystem.</p>
        </div>
      </div>
    </section>
  </motion.div>
